...
def main():
	...
	with tf.Session() as session:
		...
		for n_iter in range(args.max_iter):
			...
			if(n_iter % 10 == 0 or n_iter == args.max_iter-1):
				saver.save(session,'./custom5-transH-100',global_step=1000)
				...
				for i in range(n_test):
					...
					for i in range(len(norm_id_replace_tail)):
						...
						if val == t[2]:
							...
							if val in hr_t[(t[0], t[1])]:
								norm_ftrank -= 1
								# print("True value for tail")
					# print(norm_fhrank,norm_ftrank)
					# print("\n\n\n")
